...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference("Director.count") do
      post directors_url, params: { director: { birthdate: @director.birthdate, genre_id: @director.genre_id, name: @director.name, nationality: @director.nationality } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { birthdate: @director.birthdate, genre_id: @director.genre_id, name: @director.name, nationality: @director.nationality } }
